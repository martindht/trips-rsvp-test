...
function displayEvents(events) {
    ...
    grid.innerHTML = events.map(event => `
        <div class="event-card" onclick="openEventModal('${event.event_id}')">
            <div class="event-banner" style="background-image: url('${event.banner_url || 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800'}')">
                <div class="date-badge">📅 ${formatDate(event.start_at)}</div>
            </div>
            <div class="event-content">
                ...
                <div class="event-details">
                    ...
                    <div class="event-detail">⏰ ${formatTime(event.start_at)}</div>
                </div>
...
async function openEventModal(eventId) {
  try {
    ...
    const banner = event.banner_url || 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1200'; // Fallback banner image if none provided by the event record
